...
@Component({
  ...
  styles: [`
    ...
    .regarding-banner { background: #f1f5f9; padding: 8px 12px; border-radius: 4px; font-size: 0.85rem; }
    .regarding-banner .lbl { font-weight: 600; color: #64748b; margin-right: 8px; }
    .regarding-banner .val { font-weight: 700; color: #1e293b; }
